export default function AccountLeft() {
  return (
    <section className="hidden sm:w-[50vw] md:w-[55vw] sm:flex flex-col items-center justify-center gap-8 2xl:gap-10">
      <div className="flex flex-col items-center">
        <img src="/cta_logo1.png" alt="" className="w-24 2xl:w-25" />
        <img src="/cta_logo.png" alt="" className="w-[460px] 2xl:w-[450px]" />
      </div>
